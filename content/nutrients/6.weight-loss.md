---
title: Weight loss
cover: /nutrients/write-articles.webp
date: 2022-08-23
...
For your article to be correctly displayed in the [articles list](/nutrients), define a `cover` and `date` property in the frontmatter:
